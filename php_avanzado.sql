...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-10-2022 a las 00:51:43
...
CREATE TABLE `clientes` (
  ...
  `apellido_c` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
  `telefono_c` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
  `email_c` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
  `mensaje_c` text COLLATE utf8_spanish_ci NOT NULL
...
(1, 'Alejandro Daniel', 'alejandro@mail.com', '123', '2022-09-26 21:03:19'),
(10, 'Fernando Palma', 'fpalma@mail.com', 'cc882994945ac7e3528bc7887a66db3e', '2022-09-29 01:55:12');
